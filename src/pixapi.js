...
(function() {
  ...
  Pixnet = (function(_super) {
    ...
    Pixnet.prototype.login = function(opts) {
      ...
      if (localStorage["accessToken"] && localStorage["refreshToken"]) {
        ...
        if (this._getUrlPara('code') && opts.type !== 'custom') {
          ...
          if (opts.onGetCode) {
            opts.onGetCode.call(this, {
              code: this.data.app.code
            });
          }
          this.getTokens(opts);
        } else {
    ...
    Pixnet.prototype.logout = function() {
      this.setCode(void 0);
      this.setTokens(void 0, void 0);
      return this;
    };

    Pixnet.prototype.getTokens = function(opts) {
      var data, done, fail;
      ...
      return this._get('https://emma.pixnet.cc/oauth2/grant', {
        data: {
          ...
          return function(data) {
            ...
            return done.call(_this, response);
          };
        })(this),
        fail: (function(_this) {
          return function(data) {
            ...
            return fail.call(_this, response);
          };
        })(this)
      });
    };
