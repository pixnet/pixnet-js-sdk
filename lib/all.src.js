    ...
    PixUsers.prototype.updateAccount = function(callback, password, optionData) {
      ...
      pixnet._post('https://emma.pixnet.cc/account/info', {
        ...
        fail: (function(_this) {
          return function(data) {
            return pixnet.apiInvalidGrantFunc(function() {
              return _this.updateAccount.apply(_this, args);
            }, data, args);
          };
        })(this)
      });
    ...
    PixUsers.prototype.updatePassword = function(callback, pwd, newPwd, optionData) {
      ...
      pixnet._post('https://emma.pixnet.cc/account/password', {
        ...
        fail: (function(_this) {
          return function(data) {
            return pixnet.apiInvalidGrantFunc(function() {
              return _this.updatePassword.apply(_this, args);
            }, data, args);
          };
        })(this)
      });
    ...
    PixUsers.prototype.getAnalyticsData = function(callback, optionData) {
      ...
      pixnet._get('https://emma.pixnet.cc/account/analytics', {
        ...
        fail: (function(_this) {
          return function(data) {
            return pixnet.apiInvalidGrantFunc(function() {
              return _this.getAnalyticsData.apply(_this, args);
            }, data, args);
          };
        })(this)
      });
    ...
    PixUsers.prototype.getNotifications = function(callback, optionData) {
      ...
      pixnet._get('https://emma.pixnet.cc/account/notifications', {
        ...
        fail: (function(_this) {
          return function(data) {
            return pixnet.apiInvalidGrantFunc(function() {
              return _this.getNotifications.apply(_this, args);
            }, data, args);
          };
        })(this)
      });
