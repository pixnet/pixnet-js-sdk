(function(){var t,e,r,o,n,i,s=function(t,e){return function(){return t.apply(e,arguments)}},a={}.hasOwnProperty,c=[].indexOf||function(t){for(var e=0,r=this.length;r>e;e++)if(e in this&&this[e]===t)return e;return-1},p=function(t,e){function r(){this.constructor=t}for(var o in e)a.call(e,o)&&(t[o]=e[o]);return r.prototype=e.prototype,t.prototype=new r,t.__super__=e.prototype,t};e=function(){function t(){this._ajax=s(this._ajax,this),this._upload=s(this._upload,this),this._post=s(this._post,this),this._delete=s(this._delete,this),this._get=s(this._get,this),this._getUrlPara=s(this._getUrlPara,this),this._serialize=s(this._serialize,this)}return t.prototype._getDoc=function(t){var e,r;try{t.contentWindow&&(e=t.contentWindow.document)}catch(o){r=o,this._log("cannot get iframe.contentWindow document: "+r)}if(e)return e;try{e=t.contentDocument?t.contentDocument:t.document}catch(o){r=o,this._log("cannot get iframe.contentDocument: "+r),e=t.document}return e},t.prototype._hasProp={}.hasOwnProperty,t.prototype._extends=function(t,e){var r;e||(e={});for(r in e)a.call(e,r)&&(t[r]=e[r]);return t},t.prototype._defaultXHROptions=function(t,e){return{data:t,done:function(){return function(t){return e?e(t):void 0}}(this),fail:function(){return function(t){return e?e(t):void 0}}(this)}},t.prototype._serialize=function(t){var e,r,o;if(e="","object"==typeof t)for(r in t)a.call(t,r)&&(o=t[r],e+=""===e?"?"+r+"="+o:"&"+r+"="+o);return e},t.prototype._getUrlPara=function(t){var e,r,o,n,i,s;if(n=window.location.search,-1===n.indexOf("?"))return void 0;for(o=n.split("?")[1].split("&"),i=0,s=o.length;s>i;i++)return e=o[i],r=e.split("="),r[0]===t?r[1]:void 0},t.prototype._ajaxOpts={type:"GET",url:"",data:{},dataType:"json",charset:"UTF-8",enctype:"application/x-www-form-urlencoded"},t.prototype._get=function(t,e){return e.data.access_token&&!t.match(/^https/)&&(t=t.replace(/^http\:\/\//,"https://")),e.type="GET",e.url=t,e.data=e.data||{},e.data.format="json",this._ajax(e)},t.prototype._delete=function(t,e){return e.type="POST",e.url=t,e.data=e.data||{},e.data._method="delete",e.data.format="json",this._ajax(e)},t.prototype._post=function(t,e){return e.type="POST",e.url=t,e.data=e.data||{},e.data.format="json",this._ajax(e)},t.prototype._upload=function(t,e){return e.type="UPLOAD",e.url=t,e.data=e.data||{},e.data.format="json",this._ajax(e)},t.prototype._ajax=function(t){var e,r,o,n,i,s,c,p,u,h;switch(t=this._extends(this._ajaxOpts,t),r=1===(u=t.data.pretty_print)||"1"===u?"text":t.dataType,c=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP"),e=""+t.enctype+"; charset="+t.charset,t.type){case"GET":case"DELETE":t.url+=this._serialize(t.data),s="";break;case"POST":case"PUT":s=this._serialize(t.data).substr(1);break;case"UPLOAD":t.type="POST",s=new FormData,h=t.data;for(i in h)a.call(h,i)&&(p=h[i],s.append(i,p));e=null;break;default:s=""}return o=t.done||t.success||function(){},n=t.fail||t.error||function(){},c.open(t.type,t.url),e&&c.setRequestHeader("Content-Type",e),c.onload=function(){var t;if(c.status>=200&&c.status<400){if(t=c.responseText,"json"===r&&(t=JSON.parse(t)),"function"==typeof o)return o(t)}else if(t=c.responseText,"function"==typeof n)return n(t)},c.send(s),c},t}(),r=function(){function t(){}return t.prototype._procStop=!1,t.prototype._log=function(t){return console.log("Pixnet Log: ",t)},t.prototype._error=function(t,e){return console.error("Pixnet Error: ",t),this._procStop=!e},t}(),i=["included","extended"],n=function(){function t(){}return t.include=function(t){var e,r,o,n;if(!t)throw"include(obj) requires obj";n=t.prototype;for(r in n)o=n[r],c.call(i,r)<0&&(this.prototype[r]=o);return e=t.included,e&&e.apply(this),this},t}(),t=function(t){function o(){return o.__super__.constructor.apply(this,arguments)}return p(o,t),o.include(r),o.include(e),o}(n),o=function(t){function e(){return this.apiInvalidGrantFunc=s(this.apiInvalidGrantFunc,this),this.refreshToken=s(this.refreshToken,this),this.requestTokens=s(this.requestTokens,this),this.logout=s(this.logout,this),this.getAuthorizeUrl=s(this.getAuthorizeUrl,this),this.login=s(this.login,this),this.setCode=s(this.setCode,this),this.setTokens=s(this.setTokens,this),this.setKey=s(this.setKey,this),this.setSecret=s(this.setSecret,this),this.getData=s(this.getData,this),this.isLogin=s(this.isLogin,this),e.__super__.constructor.apply(this,arguments)}return p(e,t),e.prototype.data={app:{code:"",consumerKey:"",consumerSecret:"",callbackUrl:"",accessToken:"",refreshToken:"",isLogin:!1,loginOpts:{type:"onepage",popwin:void 0}}},e.prototype.isArray=function(t){return"[object Array]"===Object.prototype.toString.call(t)?!0:!1},e.prototype.isLogin=function(){return this.data.app.isLogin},e.prototype.getData=function(t){return t?this.data.app[t]:this.data.app},e.prototype.setSecret=function(t){return this.data.app.consumerSecret=t,this},e.prototype.setKey=function(t){return this.data.app.consumerKey=t,this},e.prototype.setTokens=function(t,e){return this.data.app.accessToken=t,this.data.app.refreshToken=e,localStorage[""+this.data.app.consumerKey+"accessToken"]=t,localStorage[""+this.data.app.consumerKey+"refreshToken"]=e,this},e.prototype.setCode=function(t){return this.data.app.code=t,this},e.prototype.init=function(t){var e;return e=function(t){return!((null!=t?!t.match(/[a-z0-9]{32}/):!0)||32!==t.length)},t.consumerKey&&(this.data.app.consumerKey=t.consumerKey),t.consumerSecret&&(this.data.app.consumerSecret=t.consumerSecret),t.callbackUrl&&(this.data.app.callbackUrl=t.callbackUrl),e(this.data.app.consumerKey)||this._error("consumerKey format is wrong"),e(this.data.app.consumerSecret)||this._error("consumerSecret format is wrong"),this._procStop?void 0:(t.login===!0&&this.login(t.loginCallback,this.data.app.loginOpts),this)},e.prototype.login=function(t,e){var r,o,n;if(e=e||{},localStorage[""+this.data.app.consumerKey+"accessToken"])this.setCode(localStorage[""+this.data.app.consumerKey+"code"]),this.setTokens(localStorage[""+this.data.app.consumerKey+"accessToken"],localStorage[""+this.data.app.consumerKey+"refreshToken"]),this.data.app.isLogin=!0,t&&t.call(this,this.data.app);else{if(e=this._extends(this.data.app.loginOpts,e),r=e.callbackUrl||this.data.app.callbackUrl,o=this.data.app.consumerKey,r||this._error("callbackUrl is not defined"),o||this._error("consumerKey is not defined"),this._procStop)return;if(this._getUrlPara("code")&&"custom"!==e.type)this.setCode(this._getUrlPara("code")),e.onGetCode&&e.onGetCode.call(this,this.data.app),this.requestTokens(t,this.data.app);else switch(n=this.getAuthorizeUrl(r,o),e.type){case"custom":e.custom||this._error("You must set a custom function for getting code from oauth2"),e.custom.apply(this,arguments);break;case"popwin":this.data.app.loginOpts.popwin=window.open(n,"getCodeWindow");break;default:location.href=n}}return this},e.prototype.getAuthorizeUrl=function(t,e){return"https://emma.pixnet.cc/oauth2/authorize?redirect_uri="+t+"&client_id="+e+"&response_type=code"},e.prototype.logout=function(t){return this.setCode(""),this.setTokens("",""),this.data.app.isLogin=!1,t&&t(),this},e.prototype.requestTokens=function(t,e){return e=this._extends(this.data.app,e),e.consumerSecret||this._error("consumerSecret is not defined"),this._get("https://emma.pixnet.cc/oauth2/grant",{data:{redirect_uri:e.callbackUrl,client_id:e.consumerKey,client_secret:e.consumerSecret,code:e.code,grant_type:"authorization_code"},done:function(e){return function(r){return e.setTokens(r.access_token,r.refresh_token),e.data.app.isLogin=!0,t?t.call(e,r):void 0}}(this),fail:function(r){return function(o){var n;return n=e&&"string"==typeof o?JSON.parse(o):o,"invalid_grant"===n.error?r.refreshToken(t):t?t.call(r,n):void 0}}(this)})},e.prototype.refreshToken=function(t,e){var r;return r=this._extends(this.data.app,{}),console.log(this.data.app),r.refreshToken||this._error("refreshToken is not defined"),r.consumerKey||this._error("consumerKey is not defined"),r.consumerSecret||this._error("consumerSecret is not defined"),this._procStop?void 0:this._get("https://emma.pixnet.cc/oauth2/grant",{data:{refresh_token:r.refreshToken,client_id:r.consumerKey,client_secret:r.consumerSecret,grant_type:"refresh_token"},done:function(e){return function(r){return e.setTokens(r.access_token,r.refresh_token),e.data.app.isLogin=!0,t?t.call(e,r):void 0}}(this),fail:function(o){return function(n){var i;return i=r&&"string"==typeof n?JSON.parse(n):n,"invalid_grant"===i.error?(o.setCode(""),e=o._extends(r,{type:"custom",custom:function(){return location.href=o.getAuthorizeUrl(r.callbackUrl,r.consumerKey)}}),o.login(t,e)):t?t.call(o,i):void 0}}(this)})},e.prototype.apiInvalidGrantFunc=function(t,e,r){var o;return o=e&&"string"==typeof e?JSON.parse(e):e,"invalid_grant"===o.error?this.refreshToken(t):(r[0].call(this,o),this._error(o.message))},e}(t),window.pixnet=new o}).call(this);
