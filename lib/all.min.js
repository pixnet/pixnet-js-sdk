...
(function(){var t;t=function(){function t(){}return t.prototype.getAccount=function(t,n){var i;return i={callback:t,optionData:n,mainUri:"account"},pixnet.getAuthApiFunc(this,this.getAccount,arguments,i),this},t.prototype.updateAccount=function(t,n,i){var a,e;return null==n&&(n=""),a={password:n},a=pixnet._extends(a,i),e={callback:t,optionData:a,mainUri:"account/info"},pixnet.postAuthApiFunc(this,this.updateAccount,arguments,e),this},t.prototype.updatePassword=function(t,n,i,a){var e,o;return n&&i?(e={password:n,new_password:i},e=pixnet._extends(e,a),o={callback:t,optionData:e,mainUri:"account/password"},pixnet.postAuthApiFunc(this,this.updatePassword,arguments,o),this):(pixnet._error("need password arguments"),this)},t.prototype.getUser=function(t,n,i){var a;return a={},a=pixnet._extends(a,i),pixnet._get("https://emma.pixnet.cc/users/"+n,pixnet._defaultXHROptions(a,t)),this},t.prototype.getAnalyticsData=function(t,n){var i;return i={callback:t,optionData:n,mainUri:"account/analytics"},pixnet.getAuthApiFunc(this,this.getAnalyticsData,arguments,i),this},t.prototype.getNotifications=function(t,n){var i;return i={callback:t,optionData:n,mainUri:"account/notifications"},pixnet.getAuthApiFunc(this,this.getNotifications,arguments,i),this},t}(),pixnet.users=new t}).call(this);